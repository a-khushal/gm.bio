...
function registerMwa(config) {
    if (getIsLocalAssociationSupported()) //TURBOPACK unreachable
    ;
    else if (getIsRemoteAssociationSupported() && config.remoteHostAuthority !== undefined) //TURBOPACK unreachable
    ;
    else ;
}
