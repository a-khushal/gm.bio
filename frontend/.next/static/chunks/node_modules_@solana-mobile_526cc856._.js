...
function getRemoteAssociateAndroidIntentURL(associationPublicKey, hostAuthority, reflectorId, associationURLBase) {
    ...
    return __awaiter(this, void 0, void 0, function*() {
        ...
        url.searchParams.set('id', "".concat(fromUint8Array(reflectorId, true)));
        protocolVersions.forEach((version)=>{
            url.searchParams.set('v', version);
        });
        return url;
...
"[project]/node_modules/@solana-mobile/wallet-standard-mobile/lib/cjs/index.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@solana-mobile/wallet-adapter-mobile/lib/cjs/index.browser.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
class BaseSolanaMobileWalletAdapter extends walletAdapterBase.BaseSignInMessageSignerWalletAdapter {
    ...
    constructor(wallet, config){
        ...
        __classPrivateFieldSet(this, _BaseSolanaMobileWalletAdapter_accountSelector, (accounts)=>__awaiter(this, void 0, void 0, function*() {
                var _a;
                const selectedBase64EncodedAddress = yield config.addressSelector.select(accounts.map((param)=>{
                    let { publicKey } = param;
                    return fromUint8Array(publicKey);
                }));
                return (_a = accounts.find((param)=>{
                    let { publicKey } = param;
                    return fromUint8Array(publicKey) === selectedBase64EncodedAddress;
                })) !== null && _a !== void 0 ? _a : accounts[0];
            }), "f");
...
//# sourceMappingURL=node_modules_%40solana-mobile_526cc856._.js.map